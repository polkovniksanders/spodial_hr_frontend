...
import TranscriptList from '@/app/components/transcript/server/transcript-list';
import SpinLoader from '@/components/ui/layout/spin-loader';

import type { TranscriptsProps } from '@/app/components/transcript/service/transcript.interface';
